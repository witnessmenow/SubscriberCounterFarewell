/*******************************************************************
    Showing Odd's 1 out sooub count on a 64x32 RGB LED Matrix
 *                                                                 *
...
// The Odd 1s Out Channel ID
#define CHANNEL_ID "UCo8bcnLyZH8tBIH9V1mLgqQ" // Had to use this to get it: https://commentpicker.com/youtube-channel-id.php
...
void drawImage(int x, int y)
{
  ...
  for (int yy = 0; yy < imageHeight; yy++)
  {
    ...
    {
      display.drawPixel(xx + x , yy + y, sooubs[counter]);
      counter++;
    }
  }
}
