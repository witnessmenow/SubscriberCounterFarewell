/*******************************************************************
    Showing 3D printing Nerd's sub count on a 64x64 RGB LED Matrix
...
// The Joel's Channel ID
#define CHANNEL_ID "UC_7aK9PpYTqt08ERh1MewlQ" // Makes up the channel URL
...
void animationHandler()
{
  ...
  if (!finishedAnimating) {
    ...
    drawImage(0, 8, image, LOGO_WIDTH, LOGO_HEIGHT);
