/*******************************************************************
    Showing Mark Rober's sub count on a 64x64 RGB LED Matrix
 *                                                                 *
...
// The Mark's Channel ID
#define CHANNEL_ID "UCY1kMZp36IQSyNx_9h4mpCg" // Had to use this to get it: https://commentpicker.com/youtube-channel-id.php
...
void drawStuff()
{
  ...
  if (!finishedAnimating) {
    ...
    // Step 2: draw tetris
    if(subCount != ""){
      finishedAnimating = tetris.drawText(1, 63);
    }
